...
export CFLAGS="${ARCH} -D__PS4__ -D__OPENORBIS__ -D__ORBIS__ -D__BSD_VISIBLE -D_BSD_SOURCE -O2 -fPIC -funwind-tables -isysroot ${OPENORBIS} -isystem ${OPENORBIS}/include -I${OPENORBIS}/usr/include"
